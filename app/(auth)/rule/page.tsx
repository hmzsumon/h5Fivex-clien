							...
							<div className='space-y-3'>
								<div className='flex items-start'>
									...
									<p className='text-sm text-gray-700'>
										All deposits are{' '}
										<span className='font-bold'>locked for 3 days</span> (72
										hours)
									</p>
								</div>
								<div className='flex items-start'>
									...
									<p className='text-sm text-gray-700'>
										During lock period, funds are used to complete marketing
										tasks
									</p>
								</div>
							</div>
						...
						<div className='bg-green-50 p-5 rounded-lg border border-green-100'>
							...
							<div className='space-y-3'>
								<div className='flex items-start'>
									...
									<p className='text-sm text-gray-700'>
										Must complete{' '}
										<span className='font-bold'>3 daily tasks</span> for 3
										consecutive days (9 total tasks)
									</p>
								</div>
								<div className='flex items-start'>
									<div className='bg-green-100 text-green-800 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0'>
									...
									<p className='text-sm text-gray-700'>
										Tasks include viewing ads, sharing products, and completing
										surveys
									</p>
								</div>
							</div>
						...
						<div className='bg-gradient-to-r from-blue-50 to-purple-50 p-5 rounded-lg border border-blue-100'>
							...
							<div className='grid md:grid-cols-3 gap-4'>
								...
								<div className='bg-white p-3 rounded-lg shadow-sm border border-gray-200'>
									...
									<div className='text-xs text-gray-600'>
										Withdraw anytime after completion
									</div>
								</div>
							</div>
						</div>
