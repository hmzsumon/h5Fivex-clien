		...
		account: [
			{
				...
				answer:
					'Click "Register" on our homepage, fill in your details, verify your email, and complete your profile setup.',
			},
			{
				question: 'Why is my account under review?',
				answer:
					"New accounts undergo a 24-hour verification process for security. You'll receive email confirmation when approved.",
			},
			{
		...
		deposits: [
			{
				...
				answer:
					'We accept USDT (TRC20/BEP20), bank transfers, and major credit cards. Minimum deposit is $10.',
			},
			{
				question: 'Why are deposits locked for 72 hours?',
				answer:
					'This security period prevents fraudulent activity and ensures transaction compliance with financial regulations.',
			},
			{
				question: "My deposit hasn't appeared in my balance",
				answer:
					'Crypto deposits may take 10-30 minutes. If longer, check the transaction hash or contact support with proof.',
			},
		],
		withdrawals: [
			{
				...
				answer:
					'This ensures active participation in our marketing ecosystem before withdrawing earnings.',
			},
			{
				question: 'How long do withdrawals take?',
				answer:
					'Processed within 0-72 hours after request. VIP members get priority processing.',
			},
			{
				question: 'Why was my withdrawal rejected?',
				answer:
					'Common reasons: incomplete tasks, unverified identity, or suspicious activity. Check your email for details.',
			},
		],
		tasks: [
			{
				...
				answer:
					'Tasks include product reviews (1-2 min), social shares, and surveys. 3 tasks/day maintains active status.',
			},
			{
				question: 'What if I miss a day?',
				answer:
					'You can make up missed tasks within 1 days without penalty. After that, earnings may be paused.',
			},
			{
				question: 'How do tasks affect my earnings?',
				answer:
					'Completed tasks boost your earning rate. 9 completed tasks unlock withdrawal capability.',
			},
		],
		vip: [
			{
				...
				answer:
					'Upgrade by referring members who deposit $100+: VIP2 (5), VIP3 (10), VIP4 (20), VIP5 (30), VIP6 (40).',
			},
			{
				question: 'What are VIP benefits?',
				answer:
					'Higher earnings (20-100%), exclusive products, priority support, and special bonuses at each level.',
			},
			{
				question: 'How often is VIP status updated?',
				answer:
					'Team qualifications are verified daily at midnight UTC. Status upgrades apply immediately.',
			},
		],
		technical: [
			{
				...
				answer:
					'Try: 1) Force close and reopen 2) Clear cache 3) Update to latest version 4) Reinstall if needed.',
			},
			{
				question: "I can't receive SMS verification",
				answer:
					'Check spam folder, ensure correct phone number, or request voice verification instead.',
			},
			{
				question: 'How to secure my account?',
				answer:
					'Enable 2FA, never share login details, use strong passwords, and verify all withdrawal emails.',
			},
		],
	};
			...
			<div className='max-w-6xl mx-auto'>
				...
				<div className='text-center mb-12'>
					...
					<p className='text-lg text-gray-600 max-w-3xl mx-auto'>
						Find answers, guides, and contact options for your H5Fivex
						experience
					</p>
				</div>
								...
								{faqs[activeCategory as keyof typeof faqs].map((faq, index) => (
									<div key={index} className='p-6'>
										...
										>
											...
											<FiArrowRight
												className={`ml-4 transform transition ${
													openQuestion === index
					...
					<div className='flex items-start'>
						...
						<div>
							...
							<p className='text-red-700'>
								Never share your password or 2FA codes. H5Fivex staff will{' '}
								<strong>never</strong> ask for this information. If contacted by
								someone claiming to be support, immediately email{' '}
								<span className='font-medium'>security@h5fivex.com</span>
							</p>
						</div>
					</div>
				</div>
