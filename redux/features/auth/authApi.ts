...
export const authApi = apiSlice.injectEndpoints({
	endpoints: (builder) => ({
		...
		checkEmailExistOrNot: builder.query<any, string>({
			query: (email) => `/check-email-exist?email=${encodeURIComponent(email)}`,
		}),
		...
		// get invite data
		getInviteData: builder.query<any, any>({
			query: () => ({
				url: `/get-invite-data`,
				method: 'GET',
			}),
		...
		//get my team get-my-team-summary
		...
		// get my team members
		getMyTeamMembers: builder.query<any, any>({
			query: () => ({
				url: `/get-my-team-members`,
			}),
		}),

		//update-user-vip-tier
		updateUserVipTier: builder.mutation<any, any>({
			query: (body) => ({
				url: `/update-user-vip-tier`,
				method: 'POST',
				body,
			}),
			invalidatesTags: ['User'],
		...
		//get my get-my-asset-details
		myAssetDetails: builder.query<any, any>({
			query: () => ({
				url: `/get-my-asset-details`,
				method: 'GET',
			}),
		}),
