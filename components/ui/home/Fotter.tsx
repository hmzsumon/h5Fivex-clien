			...
			<div className='max-w-7xl mx-auto py-12 px-6'>
				<div className='text-center mb-8'>
					...
					<p className='text-sm max-w-md mx-auto mb-4 text-gray-600 dark:text-gray-400'>
						Stay connected with our community for updates, support, and
						exclusive offers. Join us on your favorite platform.
					</p>
				</div>
				...
				<div className='text-center text-sm text-gray-500 dark:text-gray-300'>
					...
					<p>
						<a href='/terms-conditions' className='hover:text-indigo-600'>
							Terms & Conditions
						</a>{' '}
						|{' '}
