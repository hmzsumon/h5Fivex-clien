		...
		<section className='bg-gradient-to-br from-cyan-100 via-sky-200 to-indigo-100 px-4 py-12 transition-all'>
			...
			<div className='w-full rounded-xl overflow-hidden shadow-xl aspect-[16/9]'>
				<video
					...
					// controls // ⬅️ Add only for testing
				>
					<source
						src='https://res.cloudinary.com/dmtgf2yox/video/upload/v1750161852/conference_zgdlqg.mp4'
						type='video/mp4'
					/>
			...
			<p className='text-center text-sm text-gray-600 dark:text-gray-300 mt-3 leading-relaxed px-2'>
				Experience our international business conference—see how h5Fivex is
				driving global innovation and success in the eCommerce space.
			</p>
		</section>
	);
}
